        ...
        <div className="min-h-screen relative flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-grid-pattern overflow-hidden">
            ...
            >
                ...
                <div className="space-y-3 mb-6 relative z-20">
                    <button
                        onClick={() => { window.location.href = `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api'}/auth/oauth/google`; }}
                        className="w-full h-11 flex items-center justify-center gap-3 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 rounded-xl text-white font-medium text-sm transition-all duration-200"
                    >
                ...
                <div className="relative flex items-center mb-6">
                    ...
                    <span className="px-4 text-xs text-white/40 uppercase tracking-wider">or register with email</span>
                    <div className="flex-grow border-t border-white/10"></div>
                </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full h-11 bg-white/5 border border-white/10 rounded-xl px-4 pr-12 text-white placeholder:text-white/30 focus:outline-none focus:border-brand-500 focus:bg-white/10 transition-colors"
                            />
                            <button
                                type="button"
